...
from ....piper.default.feedback.arm_feedback_status import IntEnumBase
...
class ArmMsgFeedbackStatus(AttributeBase):
    '''
    feedback
    ...
    Bit Description:
        ...
        Byte 6: Error code, uint16
            ...
            bit[6]: Joint 7 angle limit exceeded (0: normal, 1: abnormal)
            bit[7]: Reserved
    ...
    def __init__(self,
        ...
        self._mode_feedback:ArmMsgFeedbackStatusEnum.ModeFeedback = ArmMsgFeedbackStatusEnum.ModeFeedback.match_value(mode_feedback)
        self.mode_feedback: int = self._mode_feedback       #模式反馈
    ...
    @property
    def mode_feedback(self) -> ArmMsgFeedbackStatusEnum.ModeFeedback:
        return self._mode_feedback
    @mode_feedback.setter
    def mode_feedback(self, value:int):
        if isinstance(value, ArmMsgFeedbackStatusEnum.ModeFeedback):
            self._mode_feedback = value
        else:
            self._mode_feedback = ArmMsgFeedbackStatusEnum.ModeFeedback.match_value(value)
    ...
    class ErrStatus(AttributeBase):
        def __init__(self):
            ...
            self.joint_7_angle_limit = False
            ...
            self.communication_status_joint_7 = False
    ...
    def err_code(self, value: int):
        ...
        self.err_status.communication_status_joint_7 = bool(value & (1 << 6))
